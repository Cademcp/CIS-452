...
public class GUIDragonTable extends GuiContainer {
	
	private static final ResourceLocation JT_GUI_TEXTURE = 
			new ResourceLocation(Reference.MOD_ID, "textures/gui/dragon_crafting_gui.png");
	private static final int TEXT_COLOR = 0x404040;		//for inventory names
	
	private final IItemHandler playerInventory;
	private final IItemHandler tableInventory;

	public GUIDragonTable(ContainerDragonTable inventorySlotsIn) {
		super(inventorySlotsIn);
		
		System.out.println("JT:    GUIDragonTable created");
